...
namespace Tests
{
    ...
    public class PatientUnitTests
    {
        ...
        [TestMethod]
        public void NegativeInsuranceTest()
        {
            //Arrange
        ...
        [TestMethod]
        public void PositiveInsuranceTest()
        {
            //Arrange
            var pati = new Patient
            {
                PlanName = "Large Employer",
                InsuranceCompany = "CHG"
            };
